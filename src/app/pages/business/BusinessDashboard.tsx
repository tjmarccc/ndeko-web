...
const topProducts = [
  { name: 'Samsung S24 Ultra', revenue: 45000000 },
  { name: 'MacBook Pro 14" M3', revenue: 38000000 },
  { name: 'WH-1000XM5', revenue: 18000000 },
  { name: 'Ankara Print Dress', revenue: 12000000 },
  { name: 'Air Fryer Pro 5L', revenue: 8000000 },
];

const topCustomers = [
  { id: 1, name: 'Adaeze Okonkwo', email: 'adaeze@email.com', totalSpent: 899000, orders: 12, status: 'Active' },
  { id: 2, name: 'Tunde Obaseki', email: 'tunde@email.com', totalSpent: 756000, orders: 8, status: 'Active' },
  { id: 3, name: 'Ngozi Ibe', email: 'ngozi@email.com', totalSpent: 1899000, orders: 15, status: 'Premium' },
  { id: 4, name: 'Ibrahim Musa', email: 'ibrahim@email.com', totalSpent: 543000, orders: 6, status: 'Active' },
  { id: 5, name: 'Blessing Osei', email: 'blessing@email.com', totalSpent: 245000, orders: 3, status: 'New' },
];

const COLORS = ['#17a39a', '#a93860', '#8b1538', '#f0ad4e', '#5b7ba1'];
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Card className="p-6 dark:bg-gray-800">
          <div className="flex items-start justify-between mb-4">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900 dark:text-white">₦24.9M</p>
            </div>
        ...
        <Card className="p-6 dark:bg-gray-800">
          <div className="flex items-start justify-between mb-4">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900 dark:text-white">766</p>
            </div>
        ...
        <Card className="p-6 dark:bg-gray-800">
          <div className="flex items-start justify-between mb-4">
            <div>
              <p className="text-gray-600 dark:text-gray-400 text-sm mb-1">Avg Order Value</p>
              <p className="text-2xl font-bold text-gray-900 dark:text-white">₦32,572</p>
            </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm text-red-600 font-medium">-0.4%</span>
            <span className="text-xs text-gray-500">vs last period</span>
          </div>
        </Card>
        ...
        <Card className="p-6 dark:bg-gray-800">
          <div className="flex items-start justify-between mb-4">
            <div>
              <p className="text-gray-600 dark:text-gray-400 text-sm mb-1">Conversion Rate</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <Card className="p-6 dark:bg-gray-800 lg:col-span-2">
          <div className="mb-6">
            <h3 className="font-bold text-gray-900 dark:text-white mb-2">Monthly Revenue</h3>
          ...
          <ResponsiveContainer width="100%" height={300}>
            <LineChart data={revenueData} margin={{ top: 5, right: 30, left: 0, bottom: 5 }}>
              ...
              <Legend />
              <Line type="monotone" dataKey="revenue" stroke="#a93860" strokeWidth={2} name="revenue" />
            </LineChart>
          </ResponsiveContainer>

          <div className="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
            <h4 className="font-bold text-gray-900 dark:text-white mb-4">MONTHLY ORDERS</h4>
            <ResponsiveContainer width="100%" height={200}>
              <BarChart data={monthlyOrdersData} margin={{ top: 5, right: 30, left: 0, bottom: 5 }}>
                <CartesianGrid strokeDasharray="3 3" stroke="#e0e0e0" />
                <XAxis dataKey="month" />
                <YAxis />
                <Tooltip />
                <Bar dataKey="orders" fill="#17a39a" radius={[8, 8, 0, 0]} />
              </BarChart>
            </ResponsiveContainer>
          </div>
        </Card>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="p-6 dark:bg-gray-800">
          <h3 className="font-bold text-gray-900 dark:text-white mb-4">Top Products by Revenue</h3>
        ...
        <Card className="p-6 dark:bg-gray-800">
          ...
          <div className="space-y-4">
            {[
              { name: 'Ndeko Search', visits: 6430, percent: 50 },
              { name: 'Direct Link', visits: 2568, percent: 20 },
              { name: 'Social Media', visits: 1928, percent: 15 },
              { name: 'Email Campaign', visits: 1284, percent: 10 },
              { name: 'Flash Deals', visits: 642, percent: 5 },
            ].map((source, idx) => (
              <div key={idx}>
                <div className="flex items-center justify-between mb-2">
                  <p className="text-sm text-gray-600 dark:text-gray-300">{source.name}</p>
                  <span className="text-xs font-medium text-gray-900 dark:text-white">{source.percent}%</span>
                </div>
                <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                  <div
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">{source.visits.toLocaleString()} visits</p>
              </div>
            ))}
          </div>
          ...
          <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
            <p className="text-xs font-medium text-gray-600 dark:text-gray-400 mb-3 uppercase">This Week's Orders</p>
            <div className="flex gap-2 h-12">
              {['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'].map((day, idx) => (
                <div
                  key={idx}
                  className="flex-1 bg-gradient-to-t from-rose-400 to-rose-300 dark:from-rose-600 dark:to-rose-500 rounded"
      ...
      <Card className="p-6 dark:bg-gray-800">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h3 className="font-bold text-gray-900 dark:text-white">Top Customers</h3>
            <p className="text-sm text-gray-500 dark:text-gray-400">Your most valuable customers</p>
          </div>
            ...
            <tbody>
              {topCustomers.map((customer) => (
                <tr key={customer.id} className="border-b border-gray-100 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/50">
                  ...
                  <td className="py-4 px-4 text-gray-600 dark:text-gray-300">{customer.orders}</td>
                  <td className="py-4 px-4">
                    <span
